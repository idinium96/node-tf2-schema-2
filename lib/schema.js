...
class Schema {
    ...
    getItemObjectFromName(name) {
        ...
        for (const effect in effects) {
            ...
            if (effect === 'hot' && !name.includes('hot ') && (name.includes('shotgun') || isContainHotInName)) {
                continue;
            }

            if (effect === 'cool' && !name.includes('cool ') && isContainCoolInName) {
                continue;
            }
