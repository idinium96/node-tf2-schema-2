...
class Schema {
    ...
    getItemObjectFromName(name) {
        ...
        if (
            (name.includes('strange part') && !name.includes('strange particulate protector')) ||
        ...
        for (const effect in effects) {
            ...
            if (effects[effect] === 3054) {
                // invalid (or not what shown on Steam item attribute) Reindoonicorn Rancher effect id
                continue;
            }
