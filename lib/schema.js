...
class Schema {
    ...
    getItemObjectFromName(name) {
        ...
        if (name.includes('unusualifier')) {
            // example: Unusual Taunt: The Trackman's Touchdown Unusualifier
