...
class Schema {
    ...
    getItemObjectFromName(name) {
        ...
        name = name
            .replace('untradable', 'non-tradeable')
            .replace('untradeable', 'non-tradeable')
            .replace('non-tradable', 'non-tradeable');
        if (name.includes('non-tradeable')) {
            console.log('"Non-Tradeable" - before', {
                name: name,
                item: item
            });
            name = name.replace('non-tradeable', '').trim();
            item.tradeable = false;
            console.log('"Non-Tradeable" - after', {
                name: name,
                item: item
            });
        }
