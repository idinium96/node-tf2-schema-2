            ...
            if (!name.includes('War Paint')) {
                if (
                    ...
                    if (name.includes('pistol')) {
                        item.defindex = pistolSkins.get(item.paintkit);
                    } else if (name.includes('rocket launcher')) {
                        item.defindex = rocketLauncherSkins.get(item.paintkit);
                    } else if (name.includes('medi gun')) {
                        item.defindex = medicgunSkins.get(item.paintkit);
                    } else if (name.includes('revolver')) {
                        item.defindex = revolverSkins.get(item.paintkit);
                    } else if (name.includes('stickybomb launcher')) {
                        item.defindex = stickybombSkins.get(item.paintkit);
                    } else if (name.includes('sniper rifle')) {
                        item.defindex = sniperRifleSkins.get(item.paintkit);
                    } else if (name.includes('flame thrower')) {
                        item.defindex = flameThrowerSkins.get(item.paintkit);
                    } else if (name.includes('minigun')) {
                        item.defindex = minigunSkins.get(item.paintkit);
                    } else if (name.includes('scattergun')) {
                        item.defindex = scattergunSkins.get(item.paintkit);
                    } else if (name.includes('shotgun')) {
                        item.defindex = shotgunSkins.get(item.paintkit);
                    } else if (name.includes('smg')) {
                        item.defindex = smgSkins.get(item.paintkit);
                    } else if (name.includes('grenade launcher')) {
                        item.defindex = grenadeLauncherSkins.get(item.paintkit);
                    } else if (name.includes('wrench')) {
                        item.defindex = wrenchSkins.get(item.paintkit);
                    } else if (name.includes('knife')) {
                        item.defindex = knifeSkins.get(item.paintkit);
                    }
                }

                console.log('returned L607', {
                    name: name,
                    item: item
                });
                return item;
